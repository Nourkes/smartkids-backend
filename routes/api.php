...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('admin')->middleware('role:admin')->group(function () {
        ...
        Route::post  ('/menus/weekly/duplicate',[MenuController::class, 'duplicateWeeklyMenu'])->name('menus.weekly.duplicate');
            Route::get('/activites/calendar', [AdminActiviteController::class, 'calendar'])
        ->name('admin.activites.calendar');
        /* Activités (admin) */
    Route::apiResource('activites', AdminActiviteController::class)
        ->parameters(['activites' => 'activite'])
        ->whereNumber('activite');         Route::patch ('/activites/{activite}/statut',            [AdminActiviteController::class, 'changeStatut']);
